...
return [
    ...
    'customer' => [
        ...
        'edit_fail'                 => '失敗にCustomerを編集しました。',
        'add_fail'                  => '失敗にCustomerを追加しました。',
        'delete_fail'               => '失敗にCustomerを削除しました。',
    ],
    'ip' => [
    ...
    'company' => [
        'edit_success'              => '成功に会社を追加しました。',
        'add_success'               => '成功に会社を追加しました。',
        'delete_success'            => '成功に会社を追加しました。',
        'edit_fail'                 => '成功に会社を追加しました。',
        'add_fail'                  => '成功に会社を追加しました。',
        'delete_fail'               => '成功に会社を追加しました。',
    ],
    'question' => [
