...
@section('title')
    {{trans('labels.title.company.add')}}
@endsection
...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{ route('company.get.index') }}">{{ trans('labels.label.company.breadcrumb.index') }}</a>
        </li>
        <li class="active">
            <strong>{{trans('labels.label.company.breadcrumb.add')}}</strong>
        </li>
    </ol>
@endsection
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="row p-w-sm">
                    ...
                    <div class="sml-box">
                        {!! Form::open(['method' => 'POST', 'id' => 'form_company', 'class' => 'form-horizontal']) !!}
                        {!! $messages !!}
