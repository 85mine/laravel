...
@section('title')
    {{trans('labels.title.customer.add')}}
@endsection
...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{ route('customer.get.index') }}">{{ trans('labels.label.customer.breadcrumb.index') }}</a>
        </li>
        <li class="active">
            <strong>{{trans('labels.label.customer.breadcrumb.add')}}</strong>
        </li>
    </ol>
@endsection
