...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/admin', 'ProjectController@admin')->name('admin.home');
    ...
    Route::get('/project/chosing-project', 'ProjectController@getChosingProject')->name('project.chosing-project');
});
